    ...
    db.beginTransaction((err) => {
        ...
        db.query(finishRecurringBillQuery, billValues, (err, result) => {
            ...
            const addTransactionQuery = `
                insert into
                    transactions
                        (transaction_name, transaction_amount, transaction_type, transaction_date, bill_id, budget_id, person_id)
                    values
                        (?, ?, ?, ?, ?, ?, ?);
            `;
            const transactionValues = [values.bill_name, values.bill_amount, values.bill_type, values.bill_date, values.bill_id, values.budget_id, values.person_id];
